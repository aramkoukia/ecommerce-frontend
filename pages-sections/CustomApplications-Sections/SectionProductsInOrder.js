...
function SectionProductsInOrder({ products }) {
  ...
  return (
    <div className={classes.section}>
      <h2 className={classes.title}>
        Custom Application - Draft Order Products
      </h2>
      <h5 className={classes.title} color="primary">
        Your Draft Invoice Number: 13545
      </h5>
      <div>
        <GridContainer>
          {products.map(({
...
export default SectionProductsInOrder;
